...
const checkFenceSequence = (farm, indexSequence, count_ul) => {
  ...
  function farmHandler(index) {
    ...
    if(isTurn && data.player_array[18] === 1 ){
      if(data.farm[index] === 'empty' || data.farm[index] === 'house') { //비어있거나 외양간만 있을 때 지을 수 있음 
        ...
        let pre_x = getFenceCount(pre_count_ul, checkFenceSequence(data.farm, pre_indexSequence, pre_count_ul))
        ...
        let x = getFenceCount(count_ul, checkFenceSequence(data.farm, indexSequence, count_ul))
        ...
        if (data.tree >= x-pre_x) {
          if(index>=0 && index<=4){
            ...
            const fenceElement1 = document.querySelector(`.fence.fenceRow1.fenceRow${formattedIndex}`);
            const fenceElement2 = document.querySelector(`.fenceCol.fenceCol1.fenceCol${formattedIndex}`);
            const fenceElement3 = document.querySelector(`.fence.fenceRow2.fenceRow${formattedIndex}`);
            const fenceElement4 = document.querySelector(`.fenceCol.fenceCol1.fenceCol${formattedIndex1}`);
            ...
            const formattedIndex = (index + 1).toString().padStart(2, "0");
            const formattedIndex1 = (index + 2).toString().padStart(2, "0");
            const fenceElement1 = document.querySelector(`.fence.fenceRow2.fenceRow${formattedIndex}`);
            const fenceElement2 = document.querySelector(`.fenceCol.fenceCol2.fenceCol${formattedIndex}`);
            const fenceElement3 = document.querySelector(`.fence.fenceRow3.fenceRow${formattedIndex}`);
            const fenceElement4 = document.querySelector(`.fenceCol.fenceCol2.fenceCol${formattedIndex1}`);
            ...
            const formattedIndex = (index + 1).toString().padStart(2, "0");
            const formattedIndex1 = (index + 2).toString().padStart(2, "0");
            const fenceElement1 = document.querySelector(`.fence.fenceRow3.fenceRow${formattedIndex}`);
            const fenceElement2 = document.querySelector(`.fenceCol.fenceCol3.fenceCol${formattedIndex}`);
            const fenceElement3 = document.querySelector(`.fence.fenceRow4.fenceRow${formattedIndex}`);
            const fenceElement4 = document.querySelector(`.fenceCol.fenceCol3.fenceCol${formattedIndex1}`);
  ...
  return (
    ...
    <div className="farmContainer">
        ...
        <div className={`Btn room1_1 ${data.fenceColor}`} onClick={() => farmHandler(0)}></div>
        <div className={`Btn room1_2 ${data.fenceColor}`} onClick={() => farmHandler(1)}></div>
        <div className={`Btn room1_3 ${data.fenceColor}`} onClick={() => farmHandler(2)}></div>
        <div className={`Btn room1_4 ${data.fenceColor}`} onClick={() => farmHandler(3)}></div>
        <div className={`Btn room1_5 ${data.fenceColor}`} onClick={() => farmHandler(4)}></div>

        <div className={`Btn room2_1 ${data.fenceColor}`} onClick={() => farmHandler(5)}></div>
        <div className={`Btn room2_2 ${data.fenceColor}`} onClick={() => farmHandler(6)}></div>
        <div className={`Btn room2_3 ${data.fenceColor}`} onClick={() => farmHandler(7)}></div>
        <div className={`Btn room2_4 ${data.fenceColor}`} onClick={() => farmHandler(8)}></div>
        <div className={`Btn room2_5 ${data.fenceColor}`} onClick={() => farmHandler(9)}></div>

        <div className={`Btn room3_1 ${data.fenceColor}`} onClick={() => farmHandler(10)}></div>
        <div className={`Btn room3_2 ${data.fenceColor}`} onClick={() => farmHandler(11)}></div>
        <div className={`Btn room3_3 ${data.fenceColor}`} onClick={() => farmHandler(12)}></div>
        <div className={`Btn room3_4 ${data.fenceColor}`} onClick={() => farmHandler(13)}></div>
        <div className={`Btn room3_5 ${data.fenceColor}`} onClick={() => farmHandler(14)}></div>
